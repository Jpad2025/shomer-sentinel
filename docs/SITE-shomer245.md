...
## Acceso panel
- LAN: `https://192.168.1.245:8443`
- Tailscale: `https://100.75.182.116:8443`
...
## Deploy
- **Último:** 16 jun 2026 — `bash tools/deploy.sh 100.75.182.116`
...
| Item | Valor |
|------|--------|
| Etiqueta en pantalla | `shomer245` |
| GUI s1panel (HTTP, **no HTTPS**) | LAN: `http://192.168.1.245:8686` · Tailscale: `http://100.75.182.116:8686` |
